...
class AdministrateurResourceIT {
    ...
    void createAdministrateur() throws Exception {
        ...
        assertThat(testAdministrateur.getPostnom()).isEqualTo(DEFAULT_POSTNOM);
        ...
        assertThat(testAdministrateur.getMail()).isEqualTo(DEFAULT_MAIL);
    }
    ...
    void putExistingAdministrateur() throws Exception {
        ...
        updatedAdministrateur.nom(UPDATED_NOM).postnom(UPDATED_POSTNOM).prenom(UPDATED_PRENOM).adresse(UPDATED_ADRESSE).mail(UPDATED_MAIL);
        ...
        assertThat(testAdministrateur.getPostnom()).isEqualTo(UPDATED_POSTNOM);
        ...
        assertThat(testAdministrateur.getMail()).isEqualTo(UPDATED_MAIL);
    }
    ...
    void partialUpdateAdministrateurWithPatch() throws Exception {
        ...
        partialUpdatedAdministrateur.nom(UPDATED_NOM).postnom(UPDATED_POSTNOM).prenom(UPDATED_PRENOM).adresse(UPDATED_ADRESSE);
