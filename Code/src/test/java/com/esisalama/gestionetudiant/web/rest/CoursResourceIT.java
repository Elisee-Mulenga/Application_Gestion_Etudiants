...
import com.esisalama.gestionetudiant.repository.CoursRepository;
import com.esisalama.gestionetudiant.service.dto.CoursDTO;
import com.esisalama.gestionetudiant.service.mapper.CoursMapper;
...
class CoursResourceIT {
    ...
    public static Cours createEntity(EntityManager em) {
        Cours cours = new Cours().titre(DEFAULT_TITRE).note(DEFAULT_NOTE);
        return cours;
    }
    ...
    public static Cours createUpdatedEntity(EntityManager em) {
        Cours cours = new Cours().titre(UPDATED_TITRE).note(UPDATED_NOTE);
        return cours;
    }
    ...
    void putExistingCours() throws Exception {
        ...
        updatedCours.titre(UPDATED_TITRE).note(UPDATED_NOTE);
    ...
    void fullUpdateCoursWithPatch() throws Exception {
        ...
        partialUpdatedCours.titre(UPDATED_TITRE).note(UPDATED_NOTE);
