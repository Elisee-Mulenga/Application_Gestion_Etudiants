...
export const ProfesseurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionEtudiantApp.professeur.delete.question">
        <Translate contentKey="gestionEtudiantApp.professeur.delete.question" interpolate={{ id: professeurEntity.id }}>
