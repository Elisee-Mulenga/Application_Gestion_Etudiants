...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESSEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROFESSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFESSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFESSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFESSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFESSEUR actions', async () => {
      const expectedActions = [
        {
