...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './donnees.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONNEES_LIST actions', async () => {
    ...
    it('dispatches FETCH_DONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DONNEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DONNEES actions', async () => {
      const expectedActions = [
        {
