...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTEINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLECTEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLECTEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLECTEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLECTEINFO actions', async () => {
      const expectedActions = [
        {
