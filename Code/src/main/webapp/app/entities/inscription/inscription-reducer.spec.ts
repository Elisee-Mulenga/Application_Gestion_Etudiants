...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSCRIPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSCRIPTION actions', async () => {
      const expectedActions = [
        {
