...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './dossiersacademique.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOSSIERSACADEMIQUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOSSIERSACADEMIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOSSIERSACADEMIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOSSIERSACADEMIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOSSIERSACADEMIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOSSIERSACADEMIQUE actions', async () => {
      const expectedActions = [
        {
