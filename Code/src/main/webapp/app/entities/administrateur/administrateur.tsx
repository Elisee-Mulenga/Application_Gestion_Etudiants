  ...
  return (
    <div>
      <h2 id="administrateur-heading" data-cy="AdministrateurHeading">
        <Translate contentKey="gestionEtudiantApp.administrateur.home.title">Administrateurs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gestionEtudiantApp.administrateur.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/administrateur/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="gestionEtudiantApp.administrateur.home.createLabel">Create new Administrateur</Translate>
          </Link>
        </div>
      </h2>
        ...
        {administrateurList && administrateurList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gestionEtudiantApp.administrateur.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gestionEtudiantApp.administrateur.home.notFound">No Administrateurs found</Translate>
            </div>
          )
        )}
      </div>
