...
export const AdministrateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionEtudiantApp.administrateur.delete.question">
        <Translate contentKey="gestionEtudiantApp.administrateur.delete.question" interpolate={{ id: administrateurEntity.id }}>
