...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GESTIONINSCRIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_GESTIONINSCRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GESTIONINSCRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GESTIONINSCRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GESTIONINSCRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GESTIONINSCRIP actions', async () => {
      const expectedActions = [
        {
