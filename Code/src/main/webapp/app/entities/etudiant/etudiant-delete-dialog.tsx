...
export const EtudiantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionEtudiantApp.etudiant.delete.question">
        <Translate contentKey="gestionEtudiantApp.etudiant.delete.question" interpolate={{ id: etudiantEntity.id }}>
