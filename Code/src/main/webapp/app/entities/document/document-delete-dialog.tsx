...
export const DocumentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionEtudiantApp.document.delete.question">
        <Translate contentKey="gestionEtudiantApp.document.delete.question" interpolate={{ id: documentEntity.id }}>
