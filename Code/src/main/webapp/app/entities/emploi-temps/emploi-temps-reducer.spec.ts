...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOITEMPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOITEMPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOITEMPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOITEMPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOITEMPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOITEMPS actions', async () => {
      const expectedActions = [
        {
