...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRESSION actions', async () => {
      const expectedActions = [
        {
