...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GESTIONINFOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GESTIONINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GESTIONINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GESTIONINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GESTIONINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GESTIONINFOS actions', async () => {
      const expectedActions = [
        {
